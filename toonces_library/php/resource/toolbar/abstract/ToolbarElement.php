 ...
 *
 */
abstract class ToolbarElement extends HTMLViewResource
{
	...
	public function __construct($pageView) {
		...
		$utilityElement = new HTMLResource($this->pageViewReference);
...
HTML;
	...
	public function buildToolElement() {
		...
		// This element's job is to add elements to the toolElement HTMLViewResource object.

		// The toolElement HTMLViewResource object should already exist once this is
		// called.
