...
class BlogPostToolbarElement extends ToolbarElement
{
	...
	public function buildToolElement() {
		...
		$editToolElement = new HTMLResource($this->pageViewReference);
		...
		if ($doDisplayPublishTool) {
			...
			$publishLinkControlResource = new PublishLinkControlResource($this->pageViewReference);
			$this->toolElement->addElement($publishLinkControlResource);

			$unPublishLinkConrolElement = new UnPublishLinkControlResource($this->pageViewReference);
			$this->toolElement->addElement($unPublishLinkConrolElement);

			$publishToolElement = new HTMLResource($this->pageViewReference);
			$publishToolElement->html = $this->buildPublishToolElementHTML();
			$this->toolElement->addElement($publishToolElement);

			$deleteToolElement = new HTMLResource($this->pageViewReference);
